...
def make_contract(**overrides) -> IntentContract:
    values = {
        ...
        "allowed_tools": ["browse_web", "read_file", "write_file"],
        "allowed_resources": ["hotel_websites", "results_file", "hotel_prices"],
...
def make_secret_label(**overrides) -> DataLabel:
    values = {
...
def make_policy_input(
    ...
    data_labels: dict[str, DataLabel] | None = None,
