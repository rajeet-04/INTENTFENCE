...
1. Opened the Agent view and observed **Runtime API ONLINE**, `qwen3:14b · local`, and **Contract pending**.
...
6. Clicked **Run controlled browse probe**.
...
- Final console error check: no errors reported.
